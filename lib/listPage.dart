...
class _ListPageState extends State<ListPage> {
  ...
  Widget build(BuildContext context) {
    ListTile makeListTile(dynamic rest) => ListTile(
          contentPadding:
    ...
    Card makeCard(dynamic rest) => Card(
          elevation: 8.0,
          ...
          child: Container(
            ...
            child: new ListTile(
              ...
              title: Text(rest.toString(), style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            )
          ),
      );
          ...
          itemBuilder: (BuildContext context, int index) {
            return new Card(
              ...
              child: Container(
                ...
                child: new ListTile(
                  contentPadding: EdgeInsets.symmetric(horizontal: 20.0, vertical: 10.0),
                  title: Text(rests[index].toString(), style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                )
              ),
            );
          },
    ...
    Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
      ...
      return Padding(
        ...
        child: Container(
          ...
          child: ListTile(
            title: Text(lunch.name, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            ...
            // subtitle: makeList(lunch.rests),
              // children: getRests(lunch.rests)
                  ...
                  Widget _buildLunchList(BuildContext context, List<DocumentSnapshot> snapshot) {
                    return ListView(
